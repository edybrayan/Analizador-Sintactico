...
_lr_productions = [
  ...
  ('expresion -> MENOS expresion','expresion',2,'p_expresion_unaria','gramatica.py',98),
  ('expresion -> PARIZQ expresion PARDER','expresion',3,'p_expresion_agrupacion','gramatica.py',102),
  ('expresion -> ENTERO','expresion',1,'p_expresion_number','gramatica.py',106),
  ('expresion -> DECIMAL','expresion',1,'p_expresion_number','gramatica.py',107),
]
